...
public enum ModBlocks {
	...
	WHITE_CONCRETE_WALL("white_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.WHITE_CONCRETE)), ItemGroup.DECORATIONS),
	ORANGE_CONCRETE_WALL("orange_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.ORANGE_CONCRETE)), ItemGroup.DECORATIONS),
	MAGENTA_CONCRETE_WALL("magenta_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.MAGENTA_CONCRETE)), ItemGroup.DECORATIONS),
	LIGHT_BLUE_CONCRETE_WALL("light_blue_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIGHT_BLUE_CONCRETE)), ItemGroup.DECORATIONS),
	YELLOW_CONCRETE_WALL("yellow_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.YELLOW_CONCRETE)), ItemGroup.DECORATIONS),
	LIME_CONCRETE_WALL("lime_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIME_CONCRETE)), ItemGroup.DECORATIONS),
	PINK_CONCRETE_WALL("pink_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.PINK_CONCRETE)), ItemGroup.DECORATIONS),
	GRAY_CONCRETE_WALL("gray_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.GRAY_CONCRETE)), ItemGroup.DECORATIONS),
	LIGHT_GRAY_CONCRETE_WALL("light_gray_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIGHT_GRAY_CONCRETE)), ItemGroup.DECORATIONS),
	CYAN_CONCRETE_WALL("cyan_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.CYAN_CONCRETE)), ItemGroup.DECORATIONS),
	PURPLE_CONCRETE_WALL("purple_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.PURPLE_CONCRETE)), ItemGroup.DECORATIONS),
	BLUE_CONCRETE_WALL("blue_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BLUE_CONCRETE)), ItemGroup.DECORATIONS),
	BROWN_CONCRETE_WALL("brown_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BROWN_CONCRETE)), ItemGroup.DECORATIONS),
	GREEN_CONCRETE_WALL("green_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.GREEN_CONCRETE)), ItemGroup.DECORATIONS),
	RED_CONCRETE_WALL("red_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.RED_CONCRETE)), ItemGroup.DECORATIONS),
	BLACK_CONCRETE_WALL("black_concrete_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BLACK_CONCRETE)), ItemGroup.DECORATIONS),
	...
	TERRACOTTA_WALL("terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.TERRACOTTA)), ItemGroup.DECORATIONS),
	WHITE_TERRACOTTA_WALL("white_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.WHITE_TERRACOTTA)), ItemGroup.DECORATIONS),
	ORANGE_TERRACOTTA_WALL("orange_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.ORANGE_TERRACOTTA)), ItemGroup.DECORATIONS),
	MAGENTA_TERRACOTTA_WALL("magenta_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.MAGENTA_TERRACOTTA)), ItemGroup.DECORATIONS),
	LIGHT_BLUE_TERRACOTTA_WALL("light_blue_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIGHT_BLUE_TERRACOTTA)), ItemGroup.DECORATIONS),
	YELLOW_TERRACOTTA_WALL("yellow_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.YELLOW_TERRACOTTA)), ItemGroup.DECORATIONS),
	LIME_TERRACOTTA_WALL("lime_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIME_TERRACOTTA)), ItemGroup.DECORATIONS),
	PINK_TERRACOTTA_WALL("pink_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.PINK_TERRACOTTA)), ItemGroup.DECORATIONS),
	GRAY_TERRACOTTA_WALL("gray_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.GRAY_TERRACOTTA)), ItemGroup.DECORATIONS),
	LIGHT_GRAY_TERRACOTTA_WALL("light_gray_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.LIGHT_GRAY_TERRACOTTA)), ItemGroup.DECORATIONS),
	CYAN_TERRACOTTA_WALL("cyan_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.CYAN_TERRACOTTA)), ItemGroup.DECORATIONS),
	PURPLE_TERRACOTTA_WALL("purple_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.PURPLE_TERRACOTTA)), ItemGroup.DECORATIONS),
	BLUE_TERRACOTTA_WALL("blue_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BLUE_TERRACOTTA)), ItemGroup.DECORATIONS),
	BROWN_TERRACOTTA_WALL("brown_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BROWN_TERRACOTTA)), ItemGroup.DECORATIONS),
	GREEN_TERRACOTTA_WALL("green_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.GREEN_TERRACOTTA)), ItemGroup.DECORATIONS),
	RED_TERRACOTTA_WALL("red_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.RED_TERRACOTTA)), ItemGroup.DECORATIONS),
	BLACK_TERRACOTTA_WALL("black_terracotta_wall", new WallBlock(FabricBlockSettings.copy(Blocks.BLACK_TERRACOTTA)), ItemGroup.DECORATIONS);
